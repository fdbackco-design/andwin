...
이 약관은 <사이트 개설일>부터 시행합니다.`;
  ...
  const privacyContent = `회사명(이하 '회사'라 한다)는 개인정보 보호법 제30조에 따라 정보 주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립, 공개합니다.
    ...
    <>
        ...
        <div className="footer__inner">
          <div className="footer__content">
            <div className="footer__section">
              <h3>앤드윈 스튜디오</h3>
              <p>서울특별시 강남구 학동로19길 16 (학동스튜디오)</p>
              <p>서울특별시 강남구 논현동 6-5 (신사스튜디오)</p>
            </div>
            <div className="footer__section">
              <h3>Contact</h3>
              ...
              <div className="footer__social">
                <a 
                  href="https://www.instagram.com/andwin_live/?igsh=Y2RydGxjMHM3anBt&utm_source=qr#" 
                ...
                <a 
                  href="https://open.kakao.com/o/sWrse9hh" 
                  className="footer__social-link" 
                  target="_blank" 
                  rel="noopener noreferrer"
        ...
        <div className="modal-overlay" onClick={() => setIsTermsModalOpen(false)}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            <div className="modal__header">
              <h2 className="modal__title">이용약관</h2>
              <button
                type="button"
            ...
            <div className="modal__body">
              <div className="modal__content">{termsContent}</div>
            </div>
          </div>
        </div>
      )}
      ...
      {isPrivacyModalOpen && (
        <div className="modal-overlay" onClick={() => setIsPrivacyModalOpen(false)}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            <div className="modal__header">
              <h2 className="modal__title">개인정보처리방침</h2>
              <button
                type="button"
                className="modal__close"
            ...
            <div className="modal__body">
              <div className="modal__content">{privacyContent}</div>
            </div>
          </div>
        </div>
      )}
